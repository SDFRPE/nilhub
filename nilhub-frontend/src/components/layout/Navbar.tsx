...
/**
 * @fileoverview Navbar de la landing page pública
 * Barra de navegación superior con glassmorphism
 * @module Navbar
 */
 ...
 * 
 * Usa glassmorphism (backdrop-blur) para efecto premium.
 * 
 * @returns Navbar renderizado
 * 
 * @example
 * // Usado en layout.tsx
 * <Navbar />
    ...
    <nav className="fixed top-0 w-full z-50 bg-white/60 backdrop-blur-xl border-b border-white/20 shadow-lg shadow-slate-900/5">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Botón de Registro (CTA principal) */}
          <Link href="/registro">
            <Button 
              size="sm" 
